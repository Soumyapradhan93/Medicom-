...
if (isset($_POST['edit_btn'])) {
    ...
    $query = "SELECT * FROM tab WHERE id = $guide_id";
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="tab_action.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="md-3">
                    ...
                    <input type="text" class="form-control" id="url" name="url" value="<?php echo htmlspecialchars($guide['url']); ?>" required>
                </div>
                ...
                <div class="mb-3">
                    <?php
                        $imagePath = "upload/" . htmlspecialchars($guide['icon']);
                        $defaultImagePath = "../profile/defaultimg.png";
                        if (!empty($guide['icon']) && file_exists($imagePath)) {
