...
<body>
    ...
    <section class="container">
        ...
        <form action="user_edit_action.php" method="post" class="form">
            <div class="input-box">
                <label>Full Name</label>
                <input type="text" value="<?php echo $val['id']; ?>" name="id" class="d-none">
                <input type="text" placeholder="Enter full name" id="fname" name="name" value="<?php echo $val['name'] ?>" />
            </div>
            <div class="input-box">
                <label>Email Address</label>
                <input type="text" value="<?php echo $val['email'] ?>" placeholder="Enter email address" id="eaddress" name="email" />
            </div>
            <div class="column">
                <div class="input-box">
                    <label>Phone Number</label>
                    <input type="number" placeholder="Enter phone number" value="<?php echo $val['phone_number'] ?>" id="pnumber" name="number" />
                </div>
            </div>
            ...
            <div class="gender-box">
                ...
                <div class="gender-option">
                    <div class="gender">
                        <input type="radio" id="check-male" value="male" <?php echo($val['gender']=='male')?"checked":"";?> name="gender" />
                        <label for="check-male">male</label>
                    </div>
                    <div class="gender">
                        <input type="radio" id="check-female" value="female" <?php echo($val['gender']=='female')?"checked":"";?> name="gender" />
                        <label for="check-female">Female</label>
                    </div>
                    <div class="gender">
                        <input type="radio" id="check-other" value="other" <?php echo($val['gender']=='prefer not to say')?"checked":"";?> name="gender" />
